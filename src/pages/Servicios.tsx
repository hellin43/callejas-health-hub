...
const Servicios = () => {
  ...
  useSeo({
    title: "Tratamientos y Servicios de Fisioterapia en Hellín",
    description: "Terapia manual, fisioterapia deportiva, rehabilitación post-operatoria y punción seca en Hellín. Descubre nuestros tratamientos especializados.",
  });
